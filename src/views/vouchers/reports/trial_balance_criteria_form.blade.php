...
@section('content')
    @pageTitle('trans'=>'vouchers','title'=>'Trial Balance','description'=>'Voucher Printing',
    'breadcrumb'=>[trans('accounts.general-ledger'),trans('vouchers.reports'),trans('vouchers.trial_balance')],
    'buttons'=> []
    )
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            <div class="col-md-4 col-md-offset-3">
                <h3>Trial Balance</h3>
                {!! Form::open(['action' => 'VouchersController@trialBalancePreview','method' => 'GET' ,'class' => '', 'id'=>'vouchers-form']) !!}
