...
@section('content')
    ...
    @pageTitle('trans'=>'vouchers','title'=>'vouchers','description'=>'Voucher Printing',
        'breadcrumb'=>[trans('accounts.general-ledger'),trans('vouchers.reports'),trans('vouchers.printing')],
    'buttons'=> []
    )
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            <div class="col-md-4 col-md-offset-3">
                ...
                {!! Form::open(['route' => 'voucher.preview_printing','method' => 'GET' ,'class' => '', 'id'=>'vouchers-form']) !!}
